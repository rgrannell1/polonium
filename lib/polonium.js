...
const doc = [
	...
	"                    Does not have to be secret, but keeping it secret / unpredicatable will enhance security."
	"",
	"Options:",
	...
	"                    More rounds make brute-force attacks more costly.",
...
const deriveKeys       = require("./derive-keys.js").deriveKeys
const convertToCharset = require("./derive-keys.js").convertToCharset
...
const main = function (args) {
	...
	*/
	...
	;["salt", "len", "rounds", "backup"].map(function (prop) {
	...
	const creatingPassword = args.create === true

	getPassword(creatingPassword, function (master) {
