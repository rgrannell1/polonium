...
const doc = [
	"Usage:",
	"    bi create <modifier> [--length=<num>] [--rounds=<num>] [-b | --backup=<str>]",
	"    bi get <modifier> [--length=<num>] [--rounds=<num>]",
	"    bi (-h | --help | --version)",
	"",
	"Arguments:",
...
const main = function (args) {
	...
	*/
	...
	getPassword(shouldVerify, function (master) {
		...
		if (shouldVerify) {
			console.log(
				'# bits of entropy: ' + entropyOf(base62password.length, 62) + ' (recommended: >= 80 bits)')
		}
